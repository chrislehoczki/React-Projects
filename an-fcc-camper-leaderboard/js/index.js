    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        this.state.list.map(function (item, i) {
          ...
          return React.createElement(TableRow, { number: i, name: item.username, recentPoints: item.recent, allTimePoints: item.alltime, img: item.img, url: "http://www.freecodecamp.com/" + itemName });
        })
      )
    );
  }
...
React.render(React.createElement(Leaderboard, null), document.getElementById("container"));